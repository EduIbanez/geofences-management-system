...
public class DatabaseFillerOnStartup implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private User adminUser = new User(null, "admin", null, "First", "Last", Date.valueOf("1992-08-07"),
    ...
    private Notification notification = new Notification(null, null, null, "No leído", Date.valueOf("2016-01-19"));

    private Notification notification2 = new Notification(null, null, null, "No leído", Date.valueOf("2016-01-20"));

    private Notification notification3 = new Notification(null, null, null, "No leído", Date.valueOf("2016-01-18"));
